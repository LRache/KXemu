...
void RVCore::do_add(const DecodeInfo &decodeInfo) {
    RD; RS1; RS2;
    this->set_gpr(rd, this->gpr[rs1] + this->gpr[rs2]);
}

void RVCore::do_sub(const DecodeInfo &decodeInfo) {
    RD; RS1; RS2;
    this->set_gpr(rd, this->gpr[rs1] - this->gpr[rs2]);
}

void RVCore::do_and(const DecodeInfo &decodeInfo) {
    RD; RS1; RS2;
    this->set_gpr(rd, this->gpr[rs1] & this->gpr[rs2]);
}

void RVCore::do_or(const DecodeInfo &decodeInfo) {
    RD; RS1; RS2;
    this->set_gpr(rd, this->gpr[rs1] | this->gpr[rs2]);
}

void RVCore::do_xor(const DecodeInfo &decodeInfo) {
    RD; RS1; RS2;
    this->set_gpr(rd, this->gpr[rs1] ^ this->gpr[rs2]);
}
