...
namespace kxemu::cpu {
    ...
    constexpr AddrSpace ACLINT   = {0x02000000, 0x00010000};
    constexpr AddrSpace MSWI     = {0x0000, 0x4000};
    constexpr AddrSpace MTIMECMP = {0x4000, 0x4000};
    constexpr AddrSpace MTIME    = {0xbff8, 0x0008};
    constexpr AddrSpace SSWI     = {0xc000, 0x4000};
    constexpr AddrSpace PLIC     = {0x0c000000, 0x4000000};
